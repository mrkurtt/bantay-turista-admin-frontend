		...
		<Container>
			...
			<FormContainer>
				...
				<div className="text-xs py-4">
					...
					<p className="text-sm py-1">
						Use a mobile device or web browser to access our content Contact us
					...
					<p className="text-sm py-1">
						...
						contact and communicate with you for internal record keeping and
						administrative purposes for contact tracing purposes.
					</p>
					<p className="text-sm py-1">
				...
				<div className="text-xs py-4">
					...
					<p className="text-sm">
						...
						hold about you. If we receive personal information about you from a
						...
						consent to provide the personal information to us. If you have
						previously agreed to us using your personal information for direct
						marketing purposes, you may change your mind at any time. We will
						provide you with the ability to unsubscribe from our email-database
						or opt out of communications. Please be aware we may need to request
				...
				<div className="text-xs py-4">
					...
					<p className="text-sm">
						...
						<span className="text-blue-500">admin@bantayturista.com</span>
					</p>
				</div>
			</FormContainer>
		</Container>
